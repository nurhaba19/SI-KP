...
class Guru extends BaseController{
    ...
    public function home(){
        ...
        $data = array(
            ...
            'siswa' =>  $this->ModelsGuru->getDataSiswaByid_pembimbing(@$_SESSION['id_pembimbing'])->getResult(),
    ...
    public function chatpembimbing(){
        ...
        if(isset($_GET['guru'])){
            ...
            $data = array(
                'kontak' => $this->ModelsGuru->getguruByidIndustri($_SESSION['id_pembimbing'])->getResult(),
