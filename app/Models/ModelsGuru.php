...
class ModelsGuru extends Model{
    ...
    public function getIndustriDibimbing($id_pembimbing){
        ...
        $build->join('industri_join_pembimbing', 'industri.id_industri = industri_join_pembimbing.id_industri');
    ...
    public function getguruByidIndustri($id_pembimbing){
        $build = $this->db->table('pembimbing');
        $build->select('pembimbing.id_pembimbing, pembimbing.nama_pembimbing');
        $build->join('industri_join_pembimbing', 'industri_join_pembimbing.id_pembimbing = pembimbing.id_pembimbing');
        $build->where('industri_join_pembimbing.id_pembimbing !=', $id_pembimbing);
        $build->distinct();
        return $build->get();
    }
    ...
    public function getDataSiswaByid_pembimbing($id_pembimbing){
