...
<section class="content">
    ...
    <div class="card-body">
        ...
        <div class="col-md-3 col-sm-6 col-12">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Nama Kampus</span>
        ...
        <div class="col-md-3 col-sm-6 col-12">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Dekan</span>
        ...
        <div class="col-md-3 col-sm-6 col-12">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Industri Bimbingan</span>
                <span class="info-box-number">
                    <?php foreach($modell->getNamaIndustriByIdPembimbing(@$_SESSION['id_pembimbing'])->getResult() as $x): ?>
                        <?= strtoupper($x->nama_industri.', ') ?>
                    <?php endforeach; ?>
                </span>
            </div>
            </div>
    ...
    <div class="card-footer">
        <div class="alert alert-light" role="alert">
            Ini adalah halaman Dashboard yang digunakan untuk mengelola Data Kerja Praktek , Silahkan digunakan dengan baik dan sampaikan jika ada keluhan dalam masalah penggunaan aplikasi. Terima kasih atas kepercayaan anda!
        </div>
    </div>
    </div>
    </div>
