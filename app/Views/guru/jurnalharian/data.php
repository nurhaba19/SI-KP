        ...
        <table class="table table-bordered" id="DataTable">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="none">Catatan Anda : </th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <br>
                        <?php if($modell->getCatatanJurnalHarian($x->id_penempatan, $_GET['tgl']) == "kosong"): ?>
                            Belum Ada Catatan
                        <?php else: ?>
                            <?= ucfirst($modell->getCatatanJurnalHarian($x->id_penempatan, $_GET['tgl'])); ?>
                        <?php endif; ?>
                    </td>
                </tr>
                <?php endforeach; ?>
