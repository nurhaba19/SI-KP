        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="card bg-white">
                        ...
                        <div class="card-header bg-white">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="catatan" id="catatan" placeholder="Jika anda berhalangan hadir, anda dapat menambahkan catatan..." class="form-control form-control-sm">
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered" id="Absensi">
                        <thead>
                            <tr>
                                <th width="10">No</th>
                                <th>Tanggal</th>
