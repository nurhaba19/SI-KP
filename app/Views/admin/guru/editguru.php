...
<div class="content-header">
    ...
    <div class="row mb-2">
        ...
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="<?= base_url('admin/pembimbing'); ?>">Pembimbing</a></li>
                ...
                <form id="EditPembimbing">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="custom-control custom-radio">
                          ...
                          <label for="customRadio2" class="custom-control-label" style="font-weight:normal;">Pembimbing Kampus</label>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select multiple class="form-control select2bs4" id="industri" name="id_industri[]" style="width: 100%;">
                                <option value="">Pilih Industri Yang Akan dibimbing oleh pembimbing ini</option>
                    ...
                    <div class="mb-3 row">
                        <label for="nama_kelas" class="col-sm-2 col-form-label">Industri Dibimbing</label>
                        <div class="col-sm-10">
                            <ul>
                            <?php foreach($modelsadmin->getIndustriByidPembimbing($j->id_pembimbing)->getResult() as $i): ?>
                                    <li class="number"><?= $i->nama_industri; ?></li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="username" readonly placeholder="Username" required value="<?= $j->username; ?>">
                        </div>
                    </div>
...
$('document').ready(function(){
    ...
    $('#industri').select2({
        theme: 'bootstrap4',
        placeholder: "Pilih Industri Yang Akan dibimbing oleh pembimbing ini",
        placeholder: "Pilih Industri Yang Akan dibimbing oleh pembimbing ini",
        allowClear: true,
        multiple:true
    });
